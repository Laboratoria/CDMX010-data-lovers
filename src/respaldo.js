...
export const infoEachPokePrinc = (pokemon) => {
    ...
    let pokeNum = document.createTextNode(pokemon.num);
    ...
    buttonPoke.onclick = function () {infoEachPoke(pokemon);};
...
function infoEachPoke (pokemon) {
    ...
    dataSheetImg.src = pokemon.img;
    let dataSheetName = document.createTextNode(pokemon.name);
    let dataSheetNum = document.createTextNode('No. Pokedex: ' + pokemon.num);
    let dataSheetType = document.createTextNode('Tipo: ' + pokemon.type);
    let dataSheetRarity = document.createTextNode('Rareza: ' + pokemon.rarity);
  ...
  // Para borrar la ficha técnica dando click al botón 'Exit'
    let nodoABorrar = document.getElementById(pokemon.num);
    document.getElementById(pokemon.num).addEventListener('click', exitDataSheet);
